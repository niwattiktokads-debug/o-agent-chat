...
osacompile -s -o "$APP" "$ROOT/scripts/open-o-agent-omni.applescript"
...
cp "$APP/Contents/Resources/OAgentOmni.icns" "$APP/Contents/Resources/applet.icns"
...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.0" "$APP/Contents/Info.plist" 2>/dev/null || /usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 1.0" "$APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion $BUNDLE_VERSION" "$APP/Contents/Info.plist" 2>/dev/null || /usr/libexec/PlistBuddy -c "Add :CFBundleVersion string $BUNDLE_VERSION" "$APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Delete :CFBundleIconName" "$APP/Contents/Info.plist" 2>/dev/null || true

xattr -cr "$APP"
codesign --force --deep --sign - "$APP" >/dev/null 2>&1 || true
touch "$APP/Contents/Info.plist" "$APP/Contents/Resources/OAgentOmni.icns" "$APP/Contents/Resources/applet.icns"
touch "$APP"
