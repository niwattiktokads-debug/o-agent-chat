...
test('omni seed starts with configured production page data', () => {
  ...
  assert.equal(seed.platformAccounts.find((account) => account.id === 'acct_fb_112154661515664').status, 'healthy')
  ...
  assert.equal(seed.platformAccounts.find((account) => account.id === 'acct_fb_vz_viris_zamara').status, 'healthy')
