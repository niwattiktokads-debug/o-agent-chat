      ...
      return [
        {
          ...
          notes: 'Disable/archive also turns off auto-reply at runtime.',
        },
        {
          objectType: 'channel',
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear disconnects provider account id without touching live credentials.',
        },
        {
          objectType: 'customer',
          defaultAction: 'archive',
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear redacts contact fields and keeps thread/order references.',
        },
        {
          objectType: 'thread',
          defaultAction: 'archive',
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear removes visible context but preserves audit linkage.',
        },
        {
          objectType: 'message',
          defaultAction: 'clear',
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear redacts text and attachments.',
        },
        {
          objectType: 'order',
          defaultAction: 'archive',
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear redacts shipping/contact fields and keeps financial totals.',
        },
        {
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Keep event audit history; clear removes external source reference only.',
        },
        {
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear redacts reasoning/source ids and keeps the decision shell.',
        },
        {
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Archive/remove from training surface without hard delete.',
        },
        {
          objectType: 'connection',
          defaultAction: 'disable',
          actions: ['archive', 'disable', 'clear', 'delete'],
          collection: 'custom_connections',
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Applied only to custom connection options in branch/test.',
        },
        {
          ...
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Clear removes provider ref and expiry only.',
        },
        {
          objectType: 'test_data',
          defaultAction: 'clear',
          actions: ['clear', 'delete'],
          collection: 'derived_collections',
          softDelete: true,
          hardDeleteBlocked: true,
          notes: 'Branch/test-only sweep across local draft, mock, and test-tagged rows.',
        },
      ]
    },
    getSettings() {
